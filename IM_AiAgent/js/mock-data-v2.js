...
// === 会话列表 ===
const CHATS = [
  { id: 'c01', contactId: 'u01', lastMsg: '如果先拿体验装，后面能补差价升级吗？', time: '09:42', unread: 2, pinned: true, priority: 'HOT',
    aiNext: '发送“体验装可抵扣升级”话术，并推荐新人组合', aiTag: '高意向', aiAgent: '销售', score: 92 },
  { id: 'c02', contactId: 'u05', lastMsg: '我下午三点有空，你让 AI 先整理一下方案。', time: '13:15', unread: 1, pinned: true, priority: 'HOT',
    aiNext: '整理企业采购方案，预约 15:00 跟进', aiTag: '大单机会', aiAgent: '销售', score: 95 },
  { id: 'c03', contactId: 'u02', lastMsg: '佣金规则我看懂了，想知道团队怎么结算。', time: '10:18', unread: 1, priority: 'WARM',
    aiNext: '推送佣金结算图，并提示可申请项目方权益', aiTag: '招商咨询', aiAgent: '销售', score: 86 },
  { id: 'c04', contactId: 'u04', lastMsg: '[AI 销售助手] 已识别 3 个价格敏感用户', time: '11:32', unread: 7, priority: 'CARE',
    aiNext: '群内发送低门槛体验装，对 3 人单独私聊', aiTag: '群转化', aiAgent: '销售', score: 79 },
  { id: 'c05', contactId: 'u03', lastMsg: '昨天拍的套装少了一个赠品。', time: '11:06', priority: 'HOT',
