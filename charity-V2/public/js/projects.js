...
(function () {
  ...
  const PROJECTS = [
    /* ===== 应急救援（3 个紧急 + 1 个历史） ===== */
    {
      ...
      region: '云南 · 鲁甸', statDonate: '¥ 280 万', statPeople: '12,000', statOrg: '12',
      goal: 300, raised: 280, urgent: true, latest: '2026-06-12', amount: 280,
    },
    {
      ...
      region: '福建 · 福州', statDonate: '¥ 180 万', statPeople: '8,000', statOrg: '8',
      goal: 200, raised: 180, urgent: true, latest: '2026-06-10', amount: 180,
    },
    {
      ...
      region: '甘肃 · 临夏', statDonate: '¥ 420 万', statPeople: '4,500', statOrg: '15',
      goal: 500, raised: 420, urgent: true, latest: '2026-06-08', amount: 420,
    },
    {
      id: 'p-em-004', cat: 'urgent', name: '西藏日喀则 6.8 级地震 · 已完成',
      icon: '🏔️', org: '中国红十字会 · 已结项',
      desc: '西藏日喀则 6.8 级地震已妥善安置，物资 100% 到位。本项目已转入"灾后重建"长线阶段。',
      region: '西藏 · 日喀则', statDonate: '¥ 520 万', statPeople: '15,000', statOrg: '20',
      goal: 500, raised: 520, urgent: false, latest: '2025-10-15', amount: 520,
    },
    ...
    /* ===== 长线陪伴（4 个） ===== */
    {
      ...
      region: '12 省 · 230 校', statDonate: '¥ 180 万/年', statPeople: '6,200', statOrg: '1',
      goal: 200, raised: 120, urgent: false, latest: '2026-01-10', amount: 120,
    },
    {
      ...
      region: '22 省 · 480 校', statDonate: '¥ 1,420 万', statPeople: '98,200', statOrg: '1',
      goal: 5000, raised: 1420, urgent: false, latest: '2024-07-01', amount: 1420,
    },
    {
      id: 'p-lt-003', cat: 'longterm', name: '"春苗营养计划" 4.0',
      icon: '🌿', org: '安利（中国）× 中国青少年发展基金会',
      desc: '为偏远地区学校持续供应儿童营养品 + 学习用品，4.0 版本新增 80 所合作学校。',
      region: '18 省 · 420 校', statDonate: '¥ 980 万', statPeople: '76,500', statOrg: '1',
      goal: 1500, raised: 980, urgent: false, latest: '2025-04-15', amount: 980,
    },
    {
      id: 'p-lt-004', cat: 'longterm', name: '贵州山火救援队常驻项目',
      icon: '🌲', org: '贵州省慈善总会',
      desc: '在贵州山区设立 3 个常驻救援物资站，常年储备灭火器材 + 应急食品。',
      region: '贵州 · 3 个物资站', statDonate: '¥ 320 万', statPeople: '—', statOrg: '3',
      goal: 500, raised: 320, urgent: false, latest: '2025-08-10', amount: 320,
    },
    ...
    /* ===== 儿童助学（3 个） ===== */
    {
      ...
      region: '8 省 · 3,000 名儿童', statDonate: '¥ 60 万', statPeople: '3,000', statOrg: '5',
      goal: 100, raised: 60, urgent: false, latest: '2025-09-01', amount: 60,
    },
    {
      id: 'p-ch-002', cat: 'children', name: '"新书包"开学季援助',
      icon: '🎒', org: '中国教育发展基金会',
      desc: '每年开学季为偏远地区 5,000 名学生捐赠新书包、文具、台灯。',
      region: '10 省 · 5,000 名学生', statDonate: '¥ 180 万', statPeople: '5,000', statOrg: '6',
      goal: 200, raised: 180, urgent: false, latest: '2025-08-25', amount: 180,
    },
    {
      id: 'p-ch-003', cat: 'children', name: '"守护花蕾"女童安全教育',
      icon: '🌸', org: '中国少年儿童基金会',
      desc: '为 800 所乡村小学提供女童安全教育课程包，含教材 + 教具 + 培训。',
      region: '12 省 · 800 校', statDonate: '¥ 240 万', statPeople: '120,000', statOrg: '4',
      goal: 300, raised: 240, urgent: false, latest: '2025-05-15', amount: 240,
    },
    ...
    /* ===== 老人关怀（2 个） ===== */
    {
      ...
      region: '15 省 · 200 个社区', statDonate: '¥ 480 万', statPeople: '12,000', statOrg: '10',
      goal: 600, raised: 480, urgent: false, latest: '2025-06-20', amount: 480,
    },
    {
      id: 'p-el-002', cat: 'elderly', name: '"银发陪伴"独居老人关爱',
      icon: '🤝', org: '中国社会工作联合会',
      desc: '为 2,000 名独居老人对接志愿者，每周上门探访 1 次 + 紧急呼叫设备。',
      region: '6 省 · 20 城', statDonate: '¥ 160 万', statPeople: '2,000', statOrg: '8',
      goal: 200, raised: 160, urgent: false, latest: '2025-04-10', amount: 160,
    },
    ...
    /* ===== 乡村建设（3 个） ===== */
    {
      ...
      region: '云南 · 怒江', statDonate: '¥ 120 万', statPeople: '1,200', statOrg: '1',
      goal: 200, raised: 120, urgent: false, latest: '2026-02-10', amount: 120,
    },
    {
      id: 'p-ru-002', cat: 'rural', name: '"顺丰村" 公益物流进村',
      icon: '🚚', org: '顺丰公益物流 × 国家邮政局',
      desc: '为 1,000 个偏远村寨开通公益物流通道，农产品出村 + 公益物资进村。',
      region: '全国 · 1,000 村', statDonate: '¥ 420 万', statPeople: '28,600', statOrg: '1',
      goal: 600, raised: 420, urgent: false, latest: '2024-04-01', amount: 420,
    },
    {
      id: 'p-ru-003', cat: 'rural', name: '"饮水思源" 山区直饮水设备',
      icon: '💧', org: '娃哈哈 × 中国农村水利协会',
      desc: '为 30 所山区学校安装直饮水设备，解决师生饮水安全问题。',
      region: '6 省 · 30 校', statDonate: '¥ 80 万', statPeople: '3,500', statOrg: '1',
      goal: 100, raised: 80, urgent: false, latest: '2026-01-15', amount: 80,
    },
    ...
    /* ===== 医疗健康（2 个） ===== */
    {
      ...
      region: '云南 · 4 县', statDonate: '¥ 90 万', statPeople: '5,000', statOrg: '3',
      goal: 100, raised: 90, urgent: false, latest: '2025-03-20', amount: 90,
    },
    {
      id: 'p-he-002', cat: 'health', name: '"校园洗手" 健康教育',
      icon: '🧴', org: '立白集团 × 中国疾控中心',
      desc: '为 240 所学校安装洗手池、捐赠洗手液 + 健康教育课程，肠胃病发病率下降 60%。',
      region: '6 省 · 240 校', statDonate: '¥ 80 万', statPeople: '24,200', statOrg: '1',
      goal: 100, raised: 80, urgent: false, latest: '2026-03-01', amount: 80,
    },
  ];
    ...
    document.getElementById('pjGrid').innerHTML = list.map(p => {
      ...
      return `
        <div class="pj-card ${catInfo.cls}" style="--c1:${catInfo.c1};--c1-soft:${catInfo.soft};">
          ...
          <div class="stats">
            <div class="s"><div class="v">${p.statDonate}</div><div class="l">筹款额</div></div>
          ...
          <div class="progress-wrap">
            ...
            <div class="pct">
              <span>📍 ${p.region}</span>
              <span><span class="pct-v">${pct}%</span> · ${p.raised}/${p.goal} 万</span>
            </div>
          </div>
          <div class="actions">
