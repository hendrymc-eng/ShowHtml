...
(function () {
  ...
  const PROJECTS = {
    ...
    'p-em-001': {
      ...
      statDonate: '¥ 280 万', statPeople: '12,000', statSpeed: '< 4h 响应',
      goal: 300, raised: 280, urgent: true, latest: '2026-06-12',
      ...
      funds: [
        { type: '食品 / 饮用水', pct: 38, val: '106 万', desc: '面包、牛奶、矿泉水、方便食品' },
        { type: '应急物资', pct: 28, val: '78 万', desc: '帐篷、棉被、衣物、照明' },
        { type: '儿童关怀', pct: 14, val: '40 万', desc: '营养餐、学习用品、心理辅导' },
        { type: '老人关怀', pct: 12, val: '34 万', desc: '慢病药品、助行器、护理' },
        { type: '物流仓储', pct: 8, val: '22 万', desc: '顺丰 24h 紧急承运 + 仓储' },
      ],
      thanks: [
    ...
    'p-em-002': {
      ...
      statDonate: '¥ 180 万', statPeople: '8,000', statSpeed: '< 6h 响应',
      goal: 200, raised: 180, urgent: true, latest: '2026-06-10',
      ...
      funds: [
        { type: '应急物资', pct: 42, val: '76 万', desc: '应急照明、保暖物资、饮用水' },
        { type: '食品', pct: 28, val: '50 万', desc: '方便食品、面包、牛奶' },
        { type: '儿童关怀', pct: 16, val: '29 万', desc: '心理疏导、学习用品、玩具' },
        { type: '物流', pct: 10, val: '18 万', desc: '本地配送 + 仓储' },
        { type: '其他', pct: 4, val: '7 万', desc: '行政、平台运维' },
      ],
      thanks: [
    ...
    'p-em-003': {
      ...
      statDonate: '¥ 420 万', statPeople: '4,500', statSpeed: '< 3h 响应',
      goal: 500, raised: 420, urgent: true, latest: '2026-06-08',
      ...
      funds: [
        { type: '应急救援', pct: 45, val: '189 万', desc: '生命通道打通、被困群众转移' },
        { type: '食品 / 饮用水', pct: 25, val: '105 万', desc: '纯净水、面包、方便食品' },
        { type: '儿童关怀', pct: 14, val: '59 万', desc: '临时学校、心理疏导' },
        { type: '老人关怀', pct: 10, val: '42 万', desc: '慢病药品、护理' },
        { type: '物流', pct: 6, val: '25 万', desc: '顺丰 24h 承运' },
      ],
      thanks: [
    ...
    'p-em-004': {
      ...
      statDonate: '¥ 520 万', statPeople: '15,000', statSpeed: '已结项',
      goal: 500, raised: 520, urgent: false, latest: '2025-10-15',
      ...
      funds: [
        { type: '应急救援', pct: 40, val: '208 万', desc: '救援队伍、生命通道' },
        { type: '食品 / 保暖', pct: 30, val: '156 万', desc: '高原专用食品、棉衣' },
        { type: '儿童关怀', pct: 18, val: '94 万', desc: '临时学校 + 营养餐' },
        { type: '老人关怀', pct: 8, val: '42 万', desc: '慢病药品、护理' },
        { type: '物流', pct: 4, val: '20 万', desc: '专机 + 高原运输' },
      ],
      thanks: [
    ...
    'p-lt-001': {
      ...
      statDonate: '¥ 180 万/年', statPeople: '6,200', statSpeed: '持续中',
      goal: 200, raised: 120, urgent: false, latest: '2026-01-10',
      ...
      funds: [
        { type: '食品采购', pct: 70, val: '126 万', desc: '面包、学生奶、鸡蛋' },
        { type: '冷链物流', pct: 18, val: '32 万', desc: '顺丰冷链配送' },
        { type: '项目管理', pct: 8, val: '15 万', desc: '学校对接、质量监督' },
        { type: '行政', pct: 4, val: '7 万', desc: '平台运维' },
      ],
      thanks: [
    ...
    'p-lt-002': {
      ...
      statDonate: '¥ 1,420 万', statPeople: '98,200', statSpeed: '持续中',
      goal: 5000, raised: 1420, urgent: false, latest: '2024-07-01',
      ...
      funds: [
        { type: '学生奶采购', pct: 78, val: '1,108 万', desc: '伊利专项供应' },
        { type: '冷链物流', pct: 14, val: '199 万', desc: '冷链配送到校' },
        { type: '项目管理', pct: 6, val: '85 万', desc: '学校对接' },
        { type: '行业研究', pct: 2, val: '28 万', desc: '白皮书 + 标准制定' },
      ],
      thanks: [
    ...
    'p-lt-003': {
      ...
      statDonate: '¥ 980 万', statPeople: '76,500', statSpeed: '持续中',
      goal: 1500, raised: 980, urgent: false, latest: '2025-04-15',
      ...
      funds: [
        { type: '营养品', pct: 55, val: '539 万', desc: '安利营养品专项' },
        { type: '学习用品', pct: 22, val: '216 万', desc: '文具、书包、台灯' },
        { type: '卫生教育', pct: 15, val: '147 万', desc: '课程包 + 培训' },
        { type: '项目管理', pct: 8, val: '78 万', desc: '学校对接 + 质量监督' },
      ],
      thanks: [
    ...
    'p-lt-004': {
      ...
      statDonate: '¥ 320 万', statPeople: '—', statSpeed: '持续中',
      goal: 500, raised: 320, urgent: false, latest: '2025-08-10',
      ...
      funds: [
        { type: '物资储备', pct: 55, val: '176 万', desc: '灭火器、应急食品、医疗' },
        { type: '队伍建设', pct: 25, val: '80 万', desc: '救援队员培训' },
        { type: '站点建设', pct: 15, val: '48 万', desc: '3 个物资站建设' },
        { type: '其他', pct: 5, val: '16 万', desc: '管理 + 行政' },
      ],
      thanks: [
    ...
    'p-ch-001': {
      ...
      statDonate: '¥ 60 万', statPeople: '3,000', statSpeed: '持续中',
      goal: 100, raised: 60, urgent: false, latest: '2025-09-01',
      ...
      funds: [
        { type: '志愿者运营', pct: 50, val: '30 万', desc: '志愿者招募、培训、管理' },
        { type: '物资', pct: 30, val: '18 万', desc: '信纸、文具、邮费' },
        { type: '项目管理', pct: 15, val: '9 万', desc: '学校对接' },
        { type: '其他', pct: 5, val: '3 万', desc: '行政' },
      ],
      thanks: [
    ...
    'p-ch-002': {
      ...
      statDonate: '¥ 180 万', statPeople: '5,000', statSpeed: '持续中',
      goal: 200, raised: 180, urgent: false, latest: '2025-08-25',
      ...
      funds: [
        { type: '书包采购', pct: 55, val: '99 万', desc: '5,000 个新书包' },
        { type: '文具', pct: 30, val: '54 万', desc: '文具套装 + 台灯' },
        { type: '物流', pct: 10, val: '18 万', desc: '配送到校' },
        { type: '其他', pct: 5, val: '9 万', desc: '管理' },
      ],
      thanks: [
    ...
    'p-ch-003': {
      ...
      statDonate: '¥ 240 万', statPeople: '120,000', statSpeed: '持续中',
      goal: 300, raised: 240, urgent: false, latest: '2025-05-15',
      ...
      funds: [
        { type: '课程开发', pct: 35, val: '84 万', desc: '教材 + 教具开发' },
        { type: '师资培训', pct: 30, val: '72 万', desc: '1,200 名讲师培训' },
        { type: '课程实施', pct: 25, val: '60 万', desc: '学校开课支持' },
        { type: '其他', pct: 10, val: '24 万', desc: '管理' },
      ],
      thanks: [
    ...
    'p-el-001': {
      ...
      statDonate: '¥ 480 万', statPeople: '12,000', statSpeed: '持续中',
      goal: 600, raised: 480, urgent: false, latest: '2025-06-20',
      ...
      funds: [
        { type: '餐食成本', pct: 70, val: '336 万', desc: '200 个社区餐食' },
        { type: '站点运营', pct: 18, val: '86 万', desc: '厨师 + 配送' },
        { type: '其他', pct: 12, val: '58 万', desc: '管理 + 设备' },
      ],
      thanks: [
    ...
    'p-el-002': {
      ...
      statDonate: '¥ 160 万', statPeople: '2,000', statSpeed: '持续中',
      goal: 200, raised: 160, urgent: false, latest: '2025-04-10',
      ...
      funds: [
        { type: '志愿者运营', pct: 45, val: '72 万', desc: '志愿者招募培训' },
        { type: '呼叫设备', pct: 30, val: '48 万', desc: '2,000 套智能呼叫' },
        { type: '管理', pct: 25, val: '40 万', desc: '项目运营' },
      ],
      thanks: [
    ...
    'p-ru-001': {
      ...
      statDonate: '¥ 120 万', statPeople: '1,200', statSpeed: '持续中',
      goal: 200, raised: 120, urgent: false, latest: '2026-02-10',
      ...
      funds: [
        { type: '设备采购', pct: 70, val: '84 万', desc: '光伏 + 储能' },
        { type: '安装', pct: 20, val: '24 万', desc: '施工 + 调试' },
        { type: '运维', pct: 10, val: '12 万', desc: '10 年运维基金' },
      ],
      thanks: [
    ...
    'p-ru-002': {
      ...
      statDonate: '¥ 420 万', statPeople: '28,600', statSpeed: '持续中',
      goal: 600, raised: 420, urgent: false, latest: '2024-04-01',
      ...
      funds: [
        { type: '物流补贴', pct: 75, val: '315 万', desc: '顺丰专项' },
        { type: '站点建设', pct: 18, val: '76 万', desc: '1,000 个村级站' },
        { type: '管理', pct: 7, val: '29 万', desc: '运营 + 培训' },
      ],
      thanks: [
    ...
    'p-ru-003': {
      ...
      statDonate: '¥ 80 万', statPeople: '3,500', statSpeed: '持续中',
      goal: 100, raised: 80, urgent: false, latest: '2026-01-15',
      ...
      funds: [
        { type: '设备采购', pct: 65, val: '52 万', desc: '直饮水设备' },
        { type: '安装', pct: 20, val: '16 万', desc: '施工' },
        { type: '运维', pct: 15, val: '12 万', desc: '滤芯更换' },
      ],
      thanks: [
    ...
    'p-he-001': {
      ...
      statDonate: '¥ 90 万', statPeople: '5,000', statSpeed: '持续中',
      goal: 100, raised: 90, urgent: false, latest: '2025-03-20',
      ...
      funds: [
        { type: '筛查设备', pct: 45, val: '40 万', desc: '彩超、HPV 检测' },
        { type: '医师培训', pct: 25, val: '23 万', desc: '县级医院培训' },
        { type: '运营', pct: 20, val: '18 万', desc: '现场组织' },
        { type: '其他', pct: 10, val: '9 万', desc: '管理' },
      ],
      thanks: [
    ...
    'p-he-002': {
      ...
      statDonate: '¥ 80 万', statPeople: '24,200', statSpeed: '持续中',
      goal: 100, raised: 80, urgent: false, latest: '2026-03-01',
      ...
      funds: [
        { type: '设施建设', pct: 60, val: '48 万', desc: '洗手池 + 洗手液' },
        { type: '健康教育', pct: 25, val: '20 万', desc: '课程包 + 培训' },
        { type: '运维', pct: 15, val: '12 万', desc: '持续补充洗手液' },
      ],
      thanks: [
  ...
  function renderHero(p, cat) {
    ...
    $('pjProgressText').textContent = '¥ ' + p.raised + ' 万 / ' + p.goal + ' 万';
